...
let autos = [
  ...
  console.log(autos[1].respuestos.concat(autos[2].respuestos))
  console.log(" ")
  ...
  console.log("Los repuestos del arreglo más caro son " + repuestosArregloMásCaro())
  console.log(" ")
  ...
  console.log("Los arreglos para Juan cuestan $" + arreglosParaJuan())
  console.log(" ")
  ...
  console.log("Las ganancias por todos los arreglos son de $" + gananciaTotalArreglos())
  console.log(" ")